...
export const ROUTES: RouteGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "tree", n: "32" },
      { id: "resizable", n: "33" },
      { id: "colorPicker", n: "34", route: "color-picker", isNew: true },
      { id: "markdown", n: "35", isNew: true },
      { id: "shortcuts", n: "36", isNew: true },
    ],
  },
  {
    groupKey: "patterns",
    items: [
      { id: "forms", n: "37" },
      { id: "stepper", n: "38" },
      { id: "emptyStates", n: "39", route: "empty-states" },
      { id: "sidebar", n: "40" },
      { id: "navbar", n: "41" },
    ],
  },
