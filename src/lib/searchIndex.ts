...
const COMPONENTS = [
  ...
  { id: "onboarding",        label: "Onboarding",        route: "onboarding",         keywords: ["onboarding", "tour", "spotlight", "first-run", "guide"] },
  ...
  { id: "cli",               label: "CLI · atelier",     route: "cli",                keywords: ["cli", "npx", "atelier", "shadcn", "add", "init", "list", "registry", "copy", "scaffold", "command line", "@atelier/cli"] },
  /* ---- About / editorial (fase 12) ---- */
  { id: "about",             label: "About",             route: "about",      keywords: ["about", "sobre", "manifesto", "why", "atelier", "principles", "history"] },
  { id: "manifesto",         label: "Manifesto",         route: "about",      keywords: ["manifesto", "principles", "non-goals", "vision", "philosophy"] },
  { id: "colophon",          label: "Colophon",          route: "colophon",   keywords: ["colophon", "how made", "stack", "fonts", "fraunces", "jetbrains mono", "metrics"] },
  { id: "stack",             label: "Stack",             route: "colophon",   keywords: ["react", "vite", "vitest", "stack", "ferramentas", "tools"] },
  { id: "credits",           label: "Credits",           route: "credits",    keywords: ["credits", "créditos", "inspirations", "vercel", "stripe", "linear", "shadcn", "tufte", "vignelli", "ruder"] },
  { id: "license",           label: "License (MIT)",     route: "license",    keywords: ["license", "licença", "mit", "open source", "free", "comercial", "atribuição"] },
  { id: "press-kit",         label: "Press kit",         route: "press-kit",  keywords: ["press", "kit", "logo", "svg", "palette", "boilerplate", "blurb", "media"] },
  { id: "logo",              label: "Logo SVG",          route: "press-kit",  keywords: ["logo", "wordmark", "svg", "brand", "identity"] },
  { id: "favicon",           label: "Favicon",           route: "favicon",    keywords: ["favicon", "icon", "monogram", "at.", "tab", "browser tab", "apple touch icon", "manifest", "theme-aware", "prefers-color-scheme", "svg favicon", "pwa icon"] },
];
