...
export function getPaginationRange({ current, total, siblings = 1, boundaries = 1 }) {
...
export function PaginationRoot({ children, ariaLabel, className = "" }) {
  const { t } = useT();
  return (
    <nav
...
export function PaginationItem({ n, active = false, onClick }) {
  return (
    <li>
      <button
        type="button"
...
export function PaginationPrev({ onClick, disabled = false, showLabel = false }) {
  const { t } = useT();
  return (
    <li>
      <button
...
export function PaginationNext({ onClick, disabled = false, showLabel = false }) {
  const { t } = useT();
  return (
    <li>
      <button
