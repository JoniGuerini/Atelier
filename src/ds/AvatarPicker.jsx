...
import { AVATAR_PRESETS, groupAvatarPresets } from "./avatarPresets.jsx";
...
export function AvatarPicker({
  ...
  const currentPreset =
    current.kind === "preset" ? presets.find((p) => p.id === current.presetId) : null;
      ...
      {pending ? (
        ...
        <>
          ...
          <div className="ds-avatar-presets">
            {["monogram", "geometric", "ornament"].map((kind) =>
              groups[kind]?.length ? (
