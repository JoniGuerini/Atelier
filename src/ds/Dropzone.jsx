...
export function DropzoneTitle({ children }) {
  return <div className="title">{children}</div>;
}

export function DropzoneHint({ children }) {
  return <div className="sub">{children}</div>;
}

/* ---------- Estado preenchido ---------- */

export function DropzoneFile({ children }) {
  return (
    <div
...
export function DropzoneFilename({ children }) {
  return (
    <div
      style={{
...
export function DropzoneMeta({ items = [] }) {
  return (
    <dl
      style={{
        display: "grid",
...
function DropzoneMetaRow({ label, value }) {
  return (
    <>
      <dt
        style={{
...
export function DropzoneActions({ children }) {
